...
EFFORT_WEIGHT = 0.001
INPUT_WEIGHT = 0.001
RELAX_WEIGHT_SQ = 10000
RELAX_WEIGHT_LIN = 10000
RELAX_MIN = -0.35
RELAX_INC = 0.05
...
class TrajectorySolver(object):
    ...
    def build_optimization_matrices(self, agent, initial_state, avoid_collision):
        ...
        if not avoid_collision:
            ...
            p_mat, q_mat, g_mat, h_mat = self.hard_constraints(agent, initial_state)
    ...
    def solve_accel_coll(self, agent, initial_state):
        ...
        if agent.collision_step == 0:
            ...
            self.in_collision = True
            self.colliding_agent = agent.agent_idx
            return 0, 0, 0, 0
    ...
    def plot_trajectories(self):
        ...
        self.trajectory_plotter.run(self.in_collision, self.colliding_agent)
